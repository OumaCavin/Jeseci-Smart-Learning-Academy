...
CREATE INDEX IF NOT EXISTS idx_testimonial_featured ON jeseci_academy.testimonials(is_featured);
...
VALUES 
    ...
    ('Emily Rodriguez', 'Student', 'University of Computer Science', 'As a computer science student, I found the learning paths here complement my coursework perfectly. The concept relationships feature helped me understand how different programming concepts interconnect.', 5, true, true, true),
    ('David Park', 'Full Stack Developer', 'StartupXYZ', 'The gamification elements keep me motivated. Earning badges and tracking my progress through the learning paths makes studying feel rewarding. The community features also helped me find a study partner.', 4, true, true, true),
    ('Amanda Foster', 'Self-Taught Programmer', 'Freelancer', 'I tried many online learning platforms, but Jeseci is different. The AI-generated content is always up-to-date, and the hands-on coding exercises with immediate feedback accelerated my learning significantly.', 5, true, true, true)
