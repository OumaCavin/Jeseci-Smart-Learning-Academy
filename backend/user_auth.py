...
class UserAuthManager:
    ...
    def _ensure_tables(self):
        ...
        try:
            ...
            alter_queries = [
                ...
                f"ALTER TABLE {DB_SCHEMA}.users ADD COLUMN IF NOT EXISTS user_id INTEGER UNIQUE NOT NULL DEFAULT nextval('users_id_seq'::regclass)",
    ...
    def register_user(self, username: str, email: str, password: str, 
        ...
        try:
            ...
            # Insert new user (id is auto-generated by SERIAL, user_id set to same value for consistency)
            insert_query = f"""
