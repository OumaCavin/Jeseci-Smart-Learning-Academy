...
class UserAuthManager:
    ...
    def _ensure_tables(self):
        ...
        try:
            ...
            CREATE TABLE IF NOT EXISTS {DB_SCHEMA}.users (
                ...
                user_id INTEGER UNIQUE NOT NULL DEFAULT nextval('users_id_seq'),
            ...
            alter_queries = [
                ...
                f"ALTER TABLE {DB_SCHEMA}.users ADD COLUMN IF NOT EXISTS user_id INTEGER UNIQUE NOT NULL DEFAULT nextval('users_id_seq')",
    ...
    def register_user(self, username: str, email: str, password: str, 
        ...
        try:
            ...
            # Generate unique user_id (using the auto-increment id from the database)
            # Since user_id is INTEGER, we'll use the id value after insertion
            ...
            # Insert new user (id is auto-generated by SERIAL, user_id uses same auto-increment value)
            insert_query = f"""
            ...
            VALUES (nextval('users_id_seq'), nextval('users_id_seq'), %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
            RETURNING id, user_id
            """
            cursor.execute(insert_query, (username, email, password_hash, first_name, 
                                        last_name, learning_style, skill_level, is_admin, admin_role,
                                        is_email_verified, verification_token, token_expires_at))
            result = cursor.fetchone()
            user_db_id = result['id']
            user_id = result['user_id']  # This will be an integer from the database
            conn.commit()
