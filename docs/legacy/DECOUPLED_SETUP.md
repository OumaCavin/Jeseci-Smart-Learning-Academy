# Jeseci Smart Learning Academy - Decoupled Architecture Setup Complete! 🎉

## Architecture Overview
This project now uses a **proven decoupled architecture** - separating frontend and backend concerns:
...
└── setup.sh             # Setup script (this file)
```

## Virtual Environment Management

The project uses **uv** for Python package management and automatically handles virtual environments:

- **Setup**: Creates a `venv/` directory in the project root
- **Activation**: Automatically activated during setup and when running the application
- **Dependencies**: Python packages are installed in the virtual environment via `requirements.txt`
