...
const MentorshipRequests: React.FC<MentorshipRequestsProps> = ({ onClose }) => {
  ...
  const handleCancelRequest = async (requestId: string) => {
    ...
    try {
      ...
      const response = await advancedCollaborationService.cancelMentorshipRequest(requestId);
      ...
      setError('An error occurred while cancelling request');
  ...
  const filteredRequests = requests.filter(request => {
    ...
    const matchesSearch = !searchQuery ||
      ...
      request.mentor_username?.toLowerCase().includes(searchQuery.toLowerCase()) ||
      ...
      <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Track and manage your mentorship requests</p>
          </div>
        </div>
        <button
          onClick={onClose}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900">
                        {request.mentor_name || request.mentor_username || 'Unknown Mentor'}
                      </h4>
            ...
            <div className="p-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">
                      {selectedRequest.mentor_name || selectedRequest.mentor_username || 'Unknown Mentor'}
                    </h3>
                    <p className="text-gray-500">@{selectedRequest.mentor_username}</p>
                  </div>
                </div>
                <button
              ...
              <div className="space-y-4">
                ...
                {selectedRequest.response_message && (
                  <div className="py-2 border-b border-gray-100">
                    ...
                    <p className="text-gray-900">{selectedRequest.response_message}</p>
                  </div>
                )}
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  {selectedRequest.responded_at && (
                    <div>
                      <span className="text-gray-500 block">Responded</span>
                      <span className="text-gray-900">
                        {new Date(selectedRequest.responded_at).toLocaleDateString()}
                      </span>
                    </div>
                  )}
                </div>
              ...
              {selectedRequest.status === 'pending' && (
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <button
                    onClick={() => {
                      handleCancelRequest(selectedRequest.request_id);
